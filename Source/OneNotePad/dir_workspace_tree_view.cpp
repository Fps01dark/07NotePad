...
DirWorkspaceTreeView::DirWorkspaceTreeView(std::shared_ptr<MessageBus> message_bus,
                                           QFileSystemModel* model, QWidget* parent)
...
QMenu* DirWorkspaceTreeView::GetMenu() const { return nullptr; }
